        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-blue-100 mb-12 text-lg leading-relaxed">
              Agende uma tricoscopia digital com nossos especialistas. 
              Vamos entender a causa da sua queda e traçar o plano ideal de reprogramação capilar.
            </p>

            <div className="space-y-8">
              <div className="flex items-start group">
                <div className="bg-blue-800 p-4 rounded-xl text-blue-300 mr-4 group-hover:bg-blue-700 transition-colors">
                  <MapPin size={24} />
                </div>
                <div>
                  <h4 className="font-bold text-white text-lg">Unidade Principal</h4>
                  <p className="text-blue-200 text-sm mt-1">R. Figueira Filho, 130 - Parnamirim<br/>Recife - PE</p>
                </div>
              </div>
              ...
              <div className="flex items-start group">
                ...
                <div>
                  <h4 className="font-bold text-white text-lg">Central de Atendimento</h4>
                  <p className="text-blue-200 text-sm mt-1">(81) 99768-1543</p>
                  <p className="text-blue-400 text-xs mt-1">Disponível no WhatsApp</p>
                </div>
              </div>
               ...
               <div className="flex items-start group">
                ...
                <div>
                  <h4 className="font-bold text-white text-lg">Horários</h4>
                  <p className="text-blue-200 text-sm mt-1">Seg - Sex: 09h às 18h<br/>Sáb: 09h às 13h</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Form Side */}
          <div className="bg-white rounded-3xl p-8 lg:p-10 text-slate-900 shadow-2xl shadow-blue-950/50">
